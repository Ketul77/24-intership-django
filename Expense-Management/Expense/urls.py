...
from .views import ExpenseCreationView , Expenselistview,Investlistview , ExpenseDetailview , ExpenseUpdateview ,ExpenseDeleteview ,receiptListView,pieChart,updatestatusview
from .import views
...
urlpatterns = [
    ...
    path("investlist/",Investlistview.as_view(),name ="invest"),
